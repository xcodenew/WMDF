...
class Example(Frame):
    ...
    def seldll(self):
        if len(self.filename)<1:
            self.updatelabel1('Select the RAM Image first.')
            return 1
        ...
        try:
            ...
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'selected_dlllist.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' dlllist -p '+processlist+' > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'selected_dlllist.txt')
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' ldrmodules -p '+processlist+' > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'selected_hidden_dlllist.txt')
    ...
    def selhandles(self):
        ...
        try:
            ...
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'selected_handles.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' handles -p '+processlist+' > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'selected_handles.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def pslist(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'pslistinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' pslist > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'pslistinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def pstree(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'pstreeinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' pstree > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'pstreeinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def psxview(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'psxviewinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' psxview > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'psxviewinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def psscan_dot(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'psscan_dot.dot'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' psscan --output=dot --output-file='+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'psscan_dot.dot')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def services(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'serviceinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' svcscan > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'serviceinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def malfind(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'malfindinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' malfind > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'malfindinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def mftparser(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'mftparserinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' mftparser -C --output=body --output-file='+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'mftparserinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
    def netscan(self):
        if len(self.filename)<1:
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'networkinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' netscan > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'networkinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def privs(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'privsinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' privs > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'privsinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def driverscan(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'driverscaninf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' driverscan > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'driverscaninf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def filescan(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'filescaninf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' filescan > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'filescaninf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def modscan(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'modscaninf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' modscan > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'modscaninf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def modules(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'modules.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' modules > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'modules.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def ssdt(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'ssdtinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' ssdt > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'ssdt.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def symlinkscan(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'symlinkscaninf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' symlinkscan > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'symlinkscaninf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def unloadedmodules(self):
        ...
        try:
            if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'unloadedmodulesinf.txt'):
                ...
                os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' unloadedmodules > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'unloadedmodulesinf.txt')
        except Exception as ex:
            self.updatelabel1(ex)
        try:
            #print os.getcwd()
    ...
    def menu11(self):
        ...
        if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'alldlllistinf.txt'):
            ...
            self.profilename=self.entry1.get()
            #print 'Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' dlllist > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'alldlllistinf.txt'
            os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' dlllist > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'alldlllistinf.txt')
    ...
    def menu12(self):
        ...
        if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'allhandlesinf.txt'):
            ...
            self.profilename=self.entry1.get()
            os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' handles > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'allhandlesinf.txt')
    ...
    def menu13(self):
        ...
        if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'allcallbacksinf.txt'):
            ...
            self.profilename=self.entry1.get()
            os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' callbacks > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'allcallbacksinf.txt')
    ...
    def menu14(self):
        ...
        if os.path.exists(os.getcwd()+os.sep+'Database'+os.sep+"Analyzed_RAM_artifacts"+os.sep+'alltimersinf.txt'):
            ...
            self.profilename=self.entry1.get()
            os.system('Volatility'+os.sep+'vola.exe  -f '+self.filename+' --profile='+self.profilename+' timers > '+'Database'+os.sep+'Analyzed_RAM_artifacts'+os.sep+'alltimersinf.txt')
    ...
    def menu21(self):
        ...
        pass
    def menu22(self):
        def plugenn(pathtoplugin,savednameoffile):
            if len(self.filename)<1:
                self.updatelabel1('Select the RAM Image first.')
                return 1
            savednameoffile=savednameoffile.split('.')
            savednameoffile=savednameoffile[0]
            plugenname=savednameoffile
            filetobesaved=plugenname+'.txt'
            try:
            	self.profilename=self.entry1.get()
            	print 
            	print 'Volatility'+os.sep+'vola.exe '+'--plugins="'+os.getcwd()+os.sep+'volplugs" '+' -f '+self.filename+' --profile='+self.profilename+' '+plugenname+' > '+os.getcwd()+os.sep+filetobesaved
            	print
                os.system('Volatility'+os.sep+'vola.exe '+'--plugins="'+os.getcwd()+os.sep+'volplugs" '+' -f '+self.filename+' --profile='+self.profilename+' '+plugenname+' > '+os.getcwd()+os.sep+filetobesaved)
                #print os.environ['TEMP']+os.sep+'vola.exe '+'--plugins="'+os.getcwd()+os.sep+'volplugs" '+' -f '+driveletter+os.sep+ramimage+' --profile='+profilename+' autoruns > '+os.getcwd()+os.sep+'autorunsinf.txt'
            except Exception as ex:
                print ex
            #return "autoruns"
            pass
        ...
        #tkMessageBox.showinfo("Important Information", "Please note this plugins needs Python installed and installation will be initiated for first use")
        tkMessageBox.showinfo("Important Information", "Plugins are accepted only in compiled python version  .pyc")
        self.filename22 = tkFileDialog.askopenfilename(**self.file_opt)
        namme=self.filename22;namme=namme.split('/')
        nammelen=len(namme)
        self.filename22=self.filename22.replace(r'/' ,os.sep)
        ...
        try:
            #print 'copy '+nameoffile+' '+os.getcwd()+os.sep+'Database'+os.sep+'whitelist_artifacts'+os.sep+ik
            #print 'copy '+self.filename31+' '+os.getcwd()+os.sep+'Volatility'+os.sep+'vola.exe'
            os.system('copy '+self.filename22+' '+os.getcwd()+os.sep+'volplugs'+os.sep+namme[nammelen-1])
            self.updatelabel1('Executing..')
            self.updatelabel1(namme[nammelen-1])
            plugenn(self.filename22,namme[nammelen-1])
    ...
    def menu31(self):
        #import os
        self.filename31 = tkFileDialog.askopenfilename(**self.file_opt)
        
        namme=self.filename31;namme=namme.split('/')
        nammelen=len(namme)
        self.filename31=self.filename31.replace(r'/' ,os.sep)
        #tkMessageBox.showinfo("Important Information", "Always use the updated version. If you are an authorized user: \nPlease map network drive to IP : \\10.12.67.240\share$ . You can get the latest version under folder X-Labs , copy the whole folder named WMDF")
        if self.filename31=='':
            return 1
        ...
        try:
            #print 'copy '+nameoffile+' '+os.getcwd()+os.sep+'Database'+os.sep+'whitelist_artifacts'+os.sep+ik
            print 'copy '+self.filename31+' '+os.getcwd()+os.sep+'Volatility'+os.sep+'vola.exe'
            os.system('copy '+self.filename31+' '+os.getcwd()+os.sep+'Volatility'+os.sep+'vola.exe')
            self.updatelabel1(namme[nammelen-1])
            self.updatelabel1('Copied..')
        except:
            pass
    ...
    def askopenfilename(self):
        ...
        namme=self.filename;namme=namme.split('/')
        nammelen=len(namme)
    ...
    def initUI(self):
        ...
        askfilenamebutton=Button(self, text="Select RAM Image",
            command=self.askopenfilename)
        askfilenamebutton2=Button(self, text="Select another Whitelist artifacts",
        ...
        fileMenu2.add_command(label="Execute Plugin", command=self.menu22)
        ...
        fileMenu3.add_command(label="Select Volatility Exe", command=self.menu31)
        ...
        askfilenamebutton.place(x=50,y=7)
        askfilenamebutton2.place(x=50,y=36)
        labeljunk=Label(self, text='enter Profile: ')
        labeljunk.place(x=50,y=70)
        self.entry1=Entry(self)
        self.entry1.insert(0, "Win7SP1x64")
        
        self.entry1.place(x=50,y=90)
        labelupdate.place(x=50,y=115)
        ...
        ######
        labelprocess=Label(self, text='Analyze Process -----------------',fg='red')
        labelprocess.place(x=300,y=10)

        pslist=Button(self, text="Analyze Pslist",
            command=self.pslist)
        pslist.place(x=300,y=40)



        psscan=Button(self, text="Analyze psxview",
            command=self.psxview)
        psscan.place(x=420,y=40)

        pstree=Button(self, text="Analyze pstree",
            command=self.pstree)
        pstree.place(x=300,y=80)

        psscan_dot=Button(self, text="Analyze psscan_dot",
            command=self.psscan_dot)
        psscan_dot.place(x=420,y=80)

        #psxview=Button(self, text="Analyze psxview",command=self.psxview)
        #psxview.place(x=300,y=120)

        labelservices=Label(self, text='Analyze Services --------------------',fg='red')
        labelservices.place(x=300,y=130)
        

        services=Button(self, text="Analyze services",
            command=self.services)
        services.place(x=300,y=160)

        labelcodeinj=Label(self, text='Analyze Code Injection ------------------',fg='red')
        labelcodeinj.place(x=300,y=200)

        malfind=Button(self, text="Analyze malfind",
            command=self.malfind)
        malfind.place(x=300,y=230)

        labelmft=Label(self, text='Analyze File Present -------------------',fg='red')
        labelmft.place(x=300,y=270)

        mftparser=Button(self, text="Analyze mftparser",
            command=self.mftparser)
        mftparser.place(x=300,y=300)

        labelnet=Label(self, text='Analyze Network Connections ----------------',fg='red')
        labelnet.place(x=300,y=340)

        netscan=Button(self, text="Analyze netscan",
            command=self.netscan)
        netscan.place(x=300,y=370)

        labelpriv=Label(self, text='Analyze Privillege -------------------',fg='red')
        labelpriv.place(x=300,y=410)

        privs=Button(self, text="Analyze privs",
            command=self.privs)
        privs.place(x=300,y=440)


        labelxtra=Label(self, text='Analyze selected Dll,Handles --------------------',fg='red')
        labelxtra.place(x=300,y=490)

        dll=Button(self, text="Analyze dll",
            command=self.seldll)
        dll.place(x=300,y=520)

        handles=Button(self, text="Analyze handles",
            command=self.selhandles)
        handles.place(x=400,y=520)

        labelxtra=Label(self, text='Analyze Kernel modules--------------------',fg='red')
        labelxtra.place(x=300,y=560)

        driverscan=Button(self, text="Analyze driverscan",
            command=self.driverscan)
        driverscan.place(x=300,y=590)

        filescan=Button(self, text="Analyze filescan",
            command=self.filescan)
        filescan.place(x=440,y=590)

        modscan=Button(self, text="Analyze modscan",
            command=self.modscan)
        modscan.place(x=300,y=630)

        modules=Button(self, text="Analyze modules",
        ...
        """
        symlinkscan=Button(self, text="Analyze symlinkscan",
            command=self.symlinkscan)
        symlinkscan.place(x=300,y=670) 

        unloadedmodules=Button(self, text="Analyze unloadedmodules",
            command=self.unloadedmodules)
        unloadedmodules.place(x=460,y=670) 

        ssdt=Button(self, text="Analyze ssdt",
            command=self.ssdt)
